...
cp %{SOURCE0} %{buildroot}/usr/share/java/.m2/repository/net/minidev/json-smart/1.1.1

mkdir -p %{buildroot}/usr/share/java/.m2/repository/net/minidev/json-smart/1.1.1
cp %{SOURCE1} %{buildroot}/usr/share/java/.m2/repository/net/minidev/json-smart/1.1.1

mkdir -p %{buildroot}/usr/share/java/.m2/repository/net/minidev/json-smart/1.1.1
cp %{SOURCE2} %{buildroot}/usr/share/java/.m2/repository/net/minidev/json-smart/1.1.1

mkdir -p %{buildroot}/usr/share/java/.m2/repository/net/minidev/json-smart/1.3.1
cp %{SOURCE3} %{buildroot}/usr/share/java/.m2/repository/net/minidev/json-smart/1.3.1

mkdir -p %{buildroot}/usr/share/java/.m2/repository/net/minidev/json-smart/1.3.1
cp %{SOURCE4} %{buildroot}/usr/share/java/.m2/repository/net/minidev/json-smart/1.3.1

mkdir -p %{buildroot}/usr/share/java/.m2/repository/net/minidev/json-smart/2.3
cp %{SOURCE5} %{buildroot}/usr/share/java/.m2/repository/net/minidev/json-smart/2.3

mkdir -p %{buildroot}/usr/share/java/.m2/repository/net/minidev/json-smart/2.3
cp %{SOURCE6} %{buildroot}/usr/share/java/.m2/repository/net/minidev/json-smart/2.3

mkdir -p %{buildroot}/usr/share/java/.m2/repository/net/minidev/minidev-parent/2.3
cp %{SOURCE7} %{buildroot}/usr/share/java/.m2/repository/net/minidev/minidev-parent/2.3

mkdir -p %{buildroot}/usr/share/java/.m2/repository/net/minidev/parent/1.3.1
cp %{SOURCE8} %{buildroot}/usr/share/java/.m2/repository/net/minidev/parent/1.3.1
